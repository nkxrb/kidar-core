...
export default defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    return () => <div ref={tableContainerRef} class="mk-list-table" style={`overflow-y: hidden;height: ${tableHeight.value}; min-height: 200px; position: relative;padding-bottom: 12px;`}>
      <Table ref={tableRef}
        rowKey={props.rowKey}
        scroll={scroll}
